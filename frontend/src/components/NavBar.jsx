  ...
  return (
    <nav className="sticky top-0 z-30 glass border-b border-slate-200/50 dark:border-slate-800/50">
      <div className="page-container flex items-center justify-between h-16">
        ...
        {/* Centre nav links — desktop only (mobile uses bottom bar) */}
          ...
          {isAuthenticated ? (
            <>
              ...
              >
                ...
                {messagesUnread > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 min-w-[1.1rem] h-[1.1rem] px-0.5 rounded-full bg-red-500 text-white text-[10px] font-bold flex items-center justify-center">
        ...
        {/* Right side — mobile: returned, theme, notifications */}
        <div className="flex md:hidden items-center gap-1">
          ...
          {isAuthenticated ? (
            ...
            <Link to="/signup" className="btn-primary text-xs px-3 py-2 min-h-[44px]">
              Sign up
            </Link>
          )}
        </div>
