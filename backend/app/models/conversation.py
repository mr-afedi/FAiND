...
from sqlalchemy import String, DateTime, ForeignKey, Enum, UniqueConstraint, Boolean
...
class Conversation(Base):
    ...
    frozen_for_suspension: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
